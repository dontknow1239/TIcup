...
void bsp_init(void)
{
	...
	uart_init(115200);	//串口初始化 115200 //Serial port initialization 115200
	USART2_init(115200);
	...
	Encoder_Init_TIM3();	//编码器初始化 //Encoder initialization
	Encoder_Init_TIM4();	//编码器初始化 //Encoder initialization

	MPU6050_Init();	//MPU6050初始化 //MPU6050 initialization
